...
const client = sanityClient({
  dataset: process.env.NEXT_PUBLIC_SANITY_PROJECT_DATASET || 'your-fallback-dataset',
  projectId: process.env.NEXT_PUBLIC_SANITY_PROJECT_ID || 'your-fallback-project-id',
